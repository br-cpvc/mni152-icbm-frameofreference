...
pipeline_img=$frameofreference/ICBM152LobeAtlasGM.nii
...
mnc2nii $tempdir/mni_icbm152_nlin_sym_09c_minc2/mni_icbm152_t1_tal_nlin_sym_09c_atlas/AtlasGrey.mnc $tempdir/ICBM152LobeAtlasGM_nii.nii
rm -rf mni_icbm152_nlin_sym_09c_minc2

# convert orientation from LPI to RAI,
# and from type uchar to short, changing file size from 8675641 to 17350930
$orient $tempdir/ICBM152LobeAtlasGM_nii.nii $tempdir/ICBM152LobeAtlasGM_nii_rai.nii -o RAI

$c3d $tempdir/ICBM152LobeAtlasGM_nii_rai.nii -replace  210 302 6 304 8 306 218 308 211 303 2 305 4 307 219 309 -shift -299 -clip 0 255 -shift 299 -replace 299 0 -type ushort -o $tempdir/ICBM152LobeAtlasGM_nii_rai_labeled.nii
# omitted: 67 300 76 301

# remove surrounding empty space
#$c3d $tempdir/ICBM152LobeAtlasGM_nii_rai_labeled.nii -trim 0vox -type ushort -o $tempdir/ICBM152LobeAtlasGM_nii_rai_labeled_trimmed.nii

# pad image to get same resolution as old image: [197, 233, 189]
#$c3d $tempdir/ICBM152LobeAtlasGM_nii_rai_labeled_trimmed.nii -pad 16x16x17vox 16x20x23vox 0 -type ushort -o $tempdir/ICBM152LobeAtlasGM_nii_rai_labeled_trimmed_padded.nii


#$c3d $tempdir/ICBM152LobeAtlasGM_nii.nii -flip xy -o $tempdir/ICBM152LobeAtlasGM_nii_flipxy.nii


final_out=$outdir/ICBM152LobeAtlasGM.nii
cp $tempdir/ICBM152LobeAtlasGM_nii_rai_labeled.nii ${final_out}
#rm -rf $tempdir
