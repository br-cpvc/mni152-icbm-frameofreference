...
mnc2nii $tempdir/mni_icbm152_nl_VI_minc2/icbm_avg_152_t1_tal_nlin_symmetric_VI_mask.mnc $tempdir/vi_mask_from_minc2.nii
...
$c3d $tempdir/vi_mask_from_minc2.nii -type uchar -o $tempdir/vi_mask_from_minc2_uchar.nii
...
$c3d $tempdir/vi_mask_from_minc2_uchar.nii -trim 0vox -type uchar -o $tempdir/vi_mask_from_minc2_uchar_trimmed.nii

# pad image to get same resolution as old image: [197, 233, 189]
###$c3d $tempdir/vi_from_minc2_uchar_trimmed.nii -pad 8x8x0vox 8x8x9vox 0 -type uchar -o $tempdir/vi_from_minc2_uchar_trimmed_padded.nii
$c3d $tempdir/vi_mask_from_minc2_uchar_trimmed.nii -pad 26x28x0vox 26x24x25vox 0 -type ushort -o $tempdir/vi_mask_from_minc2_uchar_trimmed_padded.nii

# convert orientation from LPI to RAI,
# and from type uchar to short, changing file size from 8675641 to 17350930
###$orient $tempdir/vi_from_minc2_uchar_trimmed_padded.nii $tempdir/vi_from_minc2_uchar_trimmed_padded_rai.nii RAI
$orient $tempdir/vi_mask_from_minc2_uchar_trimmed_padded.nii $tempdir/vi_mask_from_minc2_uchar_trimmed_padded_rai.nii -o RAI
...
final_out_mask=$outdir/icbm_avg_152_t1_tal_nlin_symmetric_VI_mask_original.nii
$c3d $tempdir/vi_mask_from_minc2_uchar_trimmed_padded_rai.nii -dilate 1 3x3x3 -type uchar -o ${final_out_mask}
#rm -rf $tempdir
...
$c3d ${frameofreference}/icbm_avg_152_t1_tal_nlin_symmetric_VI.nii ${final_out_mask} -ncor
